...
#define DRV_VERSION     __stringify(1.2.6.4klos)
#elif defined(CONFIG_EULER_KERNEL)
#define DRV_VERSION     __stringify(1.2.6.4elos)
#elif defined(CONFIG_UOS_KERNEL)
#define DRV_VERSION     __stringify(1.2.6.4uos)
#else
#define DRV_VERSION     __stringify(1.2.6.4)
#endif
...
#endif
{
	...
	/* only check pf queue tdm desc error : [0,7] is vaild */
