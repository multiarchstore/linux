...
#define DRV_VERSION     __stringify(1.3.6.4klos)
#elif defined(CONFIG_EULER_KERNEL)
#define DRV_VERSION     __stringify(1.3.6.4elos)
#elif defined(CONFIG_UOS_KERNEL)
#define DRV_VERSION     __stringify(1.3.6.4uos)
#else
#define DRV_VERSION     __stringify(1.3.6.4)
#endif
 ...
 **/
static s32 txgbe_init_shared_code(struct txgbe_hw *hw)
{
	s32 status;
